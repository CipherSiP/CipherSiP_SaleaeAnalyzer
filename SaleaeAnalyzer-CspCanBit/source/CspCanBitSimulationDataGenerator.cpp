...
CspCanBitSimulationDataGenerator::CspCanBitSimulationDataGenerator()
{
}
...
void CspCanBitSimulationDataGenerator::Initialize( U32 simulation_sample_rate, CspCanBitAnalyzerSettings* settings )
{
...
U32 CspCanBitSimulationDataGenerator::GenerateSimulationData( U64 largest_sample_requested, U32 sample_rate, SimulationChannelDescriptor** simulation_channels)
{
...
void CspCanBitSimulationDataGenerator::CreateDataOrRemoteFrame( U32 identifier, bool use_extended_frame_format, bool remote_frame, std::vector<U8>& data, bool get_ack_in_response )
{
...
void CspCanBitSimulationDataGenerator::AddCrc()
{	
...
U16 CspCanBitSimulationDataGenerator::ComputeCrc( std::vector<BitState>& bits, U32 num_bits )
{
...
void CspCanBitSimulationDataGenerator::WriteFrame( bool error )
{
